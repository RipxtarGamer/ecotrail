...
if (is_array($result)) {
    ...
    $html = "
        ...
        <div>
                                <p class='font-medium text-gray-700'>Permit Requirements:</p>
                                <p id='permit-info' class='text-gray-600'>$permits</p>
                                </div>
                            
                            <div>
                                <p class='font-medium text-gray-700'>Guide Requirement:</p>
                                <p id='guide-info' class='text-gray-600'>$guide</p>
                            </div>
                            <div>
                                <p class='font-medium text-gray-700'>Best Season:</p>
                                <p id='season-info' class='text-gray-600'>$plan[season]</p>
                            </div>
                            <div>
                                <p class='font-medium text-gray-700'>Difficulty Level:</p>
