...
<div class="container">
  <div class="form-container">
    <h2 class="mb-4 text-success">Submit Alert</h2>
    ...
    <form method="POST" enctype="multipart/form-data" novalidate>
      <div class="mb-3">
        ...
        <input type="text" name="alert_title" id="alert_title" class="form-control" required placeholder="Enter alert title" value="<?= htmlspecialchars($_POST['alert_title'] ?? '') ?>" />
      </div>

      <div class="mb-3">
        <label for="alert_description" class="form-label">Description *</label>
        <textarea name="alert_description" id="alert_description" rows="4" class="form-control" required placeholder="Describe the alert in detail"><?= htmlspecialchars($_POST['alert_description'] ?? '') ?></textarea>
      </div>

      <div class="mb-3">
        <label for="alert_location" class="form-label">Location *</label>
        <input type="text" name="alert_location" id="alert_location" class="form-control" required placeholder="Specify the location" value="<?= htmlspecialchars($_POST['alert_location'] ?? '') ?>" />
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="date" name="alert_date" id="alert_date" class="form-control" required value="<?= htmlspecialchars($_POST['alert_date'] ?? '') ?>" />
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="alert_type" id="alert_type" class="form-control" required placeholder="e.g. strike, roadblock" value="<?= htmlspecialchars($_POST['alert_type'] ?? '') ?>" />
      </div>

      <div class="mb-3">
        <label for="alert_alt_route" class="form-label">Alternative Route (Optional)</label>
        <textarea name="alert_alt_route" id="alert_alt_route" rows="2" class="form-control" placeholder="Optional"><?= htmlspecialchars($_POST['alert_alt_route'] ?? '') ?></textarea>
      </div>
